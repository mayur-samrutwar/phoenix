...
impl Contract {
  ...
  //   const savedCode = window.localStorage.getItem("soroban-code");
  //   return savedCode || defaultCode
  // });

  const handleCodeChange = (newCode) => {
    // setCode(newCode);
    // window.localStorage.setItem("soroban-code", newCode);
  };
        ...
        <div className="w-1/3 h-screen bg-black flex flex-col">
          <div className="h-90">
            ...
            <div className="flex flex-col h-full space-y-4">
              <div className="p-4 bg-neutral-800 text-white h-full">output</div>
              <div className="p-4 bg-neutral-800 text-white h-auto flex flex-col">
                phoenix ai
                <textarea
                  className="mt-4 bg-neutral-800 text-slate-400 border-none focus:outline-none"
                  rows={4}
            ...
            <div>
              <button
                ...
                type="button"
                class="mt-4 py-2.5 px-5 me-2 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 inline-flex items-center disabled:cursor-not-allowed"
              >
                {isGenerating ? (
                  <>
                    <svg
